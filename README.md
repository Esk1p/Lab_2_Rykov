...
### 1) Выбор игровых моделей и настройка анимаций
Я решил не использовать модели, которые были показаны преподавателем, а потому нашел свои. В качестве героя вместо дракона я взял аниме девочку из пака "Unity-Chan! Model", в котором также были все необходимые анимации.
